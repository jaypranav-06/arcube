...
export default function StudioIntro({ onOpenConsultation }) {
  return (
    <section id="studio" className="py-12 sm:py-20 bg-[#141e1a] border-b border-[#D0AE89]/15 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-10">
        
        {/* Eyebrow & Badges */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 sm:pb-6 border-b border-[#D0AE89]/15 gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 pt-6 sm:pt-10 items-baseline">
          <div className="lg:col-span-8">
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-light text-[#F5F0E8] leading-[1.2] font-display tracking-tight mb-4 sm:mb-5">
          ...
          <div className="lg:col-span-4 space-y-4 pt-2 lg:pt-0">
            <div className="p-4 sm:p-5 rounded-sm bg-[#192420]/80 border border-[#D0AE89]/20">
              ...
              <p className="text-xs sm:text-sm text-[#F5F0E8] font-sans leading-relaxed mb-3">
                Apartments, family homes, and holiday villas across Colombo, Galle, and Bentota.
              </p>
